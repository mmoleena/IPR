...
window.location.href='http://'+host+':'+port+'/IndianWildLife/CheckUserAction?userName='
+userName+"&path=./RegistrationForm.jsp";
}
</script>
<style type="text/css">
.Title {
...
<body>
    ...
    <form action="./RegisterAction" name="register"
    ...
    size="20" onblur="goOn()" />
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <font color="black"> ${requestScope.status }
    </font>
    <td align='left'>
...
<td>
<input type="password"
name="conformpassword" value="" size="20"
...
<option value="user">
<font size="3"
face="Verdana">User</font>
</option>
<option value="V">
    <font size="3"
    face="Verdana">Veterinarian</font>
    </option>
    <option value="C">
    <font size="3"
    face="Verdana">Conservationist</font>
    </option>
    </select>
    </td>
    <tr>
    ...
    pastime?">
    <font size="3"
    face="Verdana">What is your favorite
    pastime?</font>
    </option>
    <option value="Who your childhood
    hero?">
    <font size="3"
    face="Verdana">Who your childhood hero?</font>
    </option>
    <option value="What is the name of your
    first school?">
    <font size="3"
    face="Verdana">What is the name of your
    first school?</font>
    </option>
    <option value="Where did you meet your
    spouse?">
    <font size="3"
face="Verdana">Where did you meet your
spouse?</font>
</option>
<option value="What is your favorite
sports team?">
...
<option value="What is your father
middle name?">
<font size="3"
face="Verdana">What is your father middle
name?</font>
</option>
<option value="What was your high
school mascot?">
<font size="3"
face="Verdana">What was your high school
mascot?</font>
</option>
<option value="What make was your
first car or bike?">
<font size="3"
face="Verdana">What make was your first
car or bike?</font>
</option>
<option value="What is your pet
name?">
<font size="3"
face="Verdana">What is your pet name?</font>
</option>
</select>
</td>
</tr>
...
<tr>
<td>
<span class="style3"><font size="3"
face="verdana"></font>
</td>
<td>
<input type="text" name="ownquest"
disabled="disabled" size="37" />
</td>
</tr>
<tr>
<td align='right'>
...
<td>
<input type="text" name="secrete" value=""
size="20" />
</td>
</tr>
<tr></tr>
...
readonly="readonly" />
<a
href="javascript:show_calendar('document.register.birthdate',
document.register.birthdate.value);">
<img src="images/cal.gif" alt="a"
width="18" height="18"
border="0" /> </a>
</td>
<td align='right'>
...
<td>
<input type="text" name="houseNo" value=""
size="20" />
</td>
<td width="120" align='right'>
District :
